...
The two projects share a documentation home but have separate source repositories and release histories. Choose based on the interface described by the upstream project documentation.
...
Physics, derivation, analysis, reproducibility, publication → DASC
```

## Before using either project

Verify current installation, compatibility, and release details against the selected upstream repository and the exact provenance shown on each imported page.
